        ...
        <div class="suite">
          <div class="image-stack">
            <div class="image-stack-item image-stack-item-top">
              <div class="overlay"></div>
              <img src="{{url('/layout_landing')}}/images/room_2_a.jpg" alt="Image" class="img-fluid pic1">
            </div>
            <div class="image-stack-item image-stack-item-bottom" data-jarallax-element="-50">
              <div class="overlay"></div>
              <img src="{{url('/layout_landing')}}/images/room_2_b.jpg" alt="Image" class="img-fluid pic2">
            </div>
          </div>
        </div>
