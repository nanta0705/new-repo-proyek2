    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 pr-md-5">
          <h3>About Us</h3>
          <p>Jasa Makeup Artist terbaik di Indramayu, lebih mudah dalam pemesanan makeup artist.</p>
            ...
            {{-- <div class="col-md-9 ml-auto">
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <h3>Telephone</h3>
                  <p>
                    <a href="#">0812 2563 8236</a>

                  </p>
                </div>
              </div>

              <h3 class="mb-0">Join our new style makeup</h3>
